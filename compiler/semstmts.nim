...
proc semProcAux(c: PContext, n: PNode, kind: TSymKind,
  ...
  #      the same as the the implementation. Additionally, this gets extra
  #      complicated when we use compile time expressions that could result in
  #      different values between forward and implemention.
  #
  ...
  if proto == nil:
    ...
    if sfGenSym in s.flags:
      # XXX: should this be the declaration scope instead of the current? 
